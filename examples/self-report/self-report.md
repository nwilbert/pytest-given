...
`tests/unit/capture/test_glossary.py:132::test_verb_call_returns_inflection_sharing_term_identity` · happy-path
...
`tests/unit/capture/test_glossary.py:152::test_glossary_actor_registers_and_returns_handle` · happy-path
...
`tests/unit/capture/test_story.py:115::test_path_dispatches_bare_string_to_activity_word` · story-grammar, happy-path
...
`tests/unit/capture/test_story.py:131::test_path_rejects_path_with_fewer_than_three_parts` · story-grammar, validation
...
`tests/unit/capture/test_story.py:146::test_path_rejects_work_object_in_position_0` · story-grammar, validation
...
`tests/unit/capture/test_story.py:161::test_path_rejects_verb_in_position_0` · story-grammar, validation
...
`tests/unit/capture/test_story.py:176::test_path_allows_bare_string_in_position_0` · story-grammar, happy-path
...
`tests/unit/capture/test_story.py:187::test_path_rejects_actor_in_position_1` · story-grammar, validation
...
`tests/unit/capture/test_story.py:202::test_path_rejects_work_object_in_position_1` · story-grammar, validation
...
`tests/unit/capture/test_story.py:217::test_path_rejects_verb_in_position_2` · story-grammar, validation
...
`tests/unit/capture/test_story.py:232::test_path_allows_bare_verb_between_term_nodes` · story-grammar, happy-path
...
`tests/unit/capture/test_story.py:248::test_path_allows_fully_bare_path` · story-grammar, happy-path
...
`tests/unit/capture/test_story.py:268::test_path_allows_node_edge_alternation_with_connective` · story-grammar, happy-path
...
`tests/unit/capture/test_story.py:294::test_path_rejects_dangling_edge` · story-grammar, validation
...
`tests/unit/capture/test_story.py:319::test_activity_single_path_synthesizes_one_path` · story-grammar, happy-path
...
`tests/unit/report/test_coverage.py:149::test_a_refs_unions_across_multi_path_activity` · happy-path
...
`tests/unit/report/test_coverage.py:200::test_s_for_step_instance_entity_ref_adds_canonical_fallback` · happy-path
...
`tests/unit/report/test_coverage.py:216::test_s_for_step_verb_ref_always_canonical` · happy-path
...
`tests/unit/report/test_coverage.py:253::test_compute_coverage_covers_canonical_activity_via_instance_step` · happy-path
...
`tests/unit/report/test_coverage.py:285::test_compute_coverage_does_not_cover_instance_activity_with_canonical_step` · happy-path
