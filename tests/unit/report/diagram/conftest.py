...
def trip_glossary() -> Glossary:
    return Glossary(
        terms=[
            ...
            GlossaryTerm(
                id=TermId('booking-system'),
                kind='actor',
                canonical='Booking System',
                definition='Reservation back-end.',
            ),
            GlossaryTerm(
                id=TermId('booking'),
                kind='object',
            ...
            GlossaryTerm(
                id=TermId('confirmation'),
                kind='object',
                canonical='Confirmation',
                definition='Success notification.',
            ),
            ...
            GlossaryTerm(
                id=TermId('loyalty-points'), kind=None, canonical='loyalty points'
            ),
        ]
    )
